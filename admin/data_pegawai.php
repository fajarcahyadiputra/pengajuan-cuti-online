...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Data Pegawai <small>Daftar pegawai kelurahan telaga asih</small></h2>
                    ...
                    <div class="modal-body">
                      <form class="" action="delete_pegawai.php" method="get">
                        <div class="form-group">
                          ...
                          <label>Semua data user, cuti akan hilang</label>
                      ...
                      <form class="" action="edit_pegawai.php" method="get">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="jabatan">
                            ...
                            ?>
                              <option <?php echo $rowjab['id_jabatan'] == $row['id_jabatan'] ? "selected" : ''  ?> value="<?php echo $rowjab['id_jabatan']; ?>"><?php echo $rowjab['nama_jabatan']; ?></option>
                            <?php
                            }
                            ?>
                          </select>
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="golongan">
                            ...
                            while ($rowjab = mysqli_fetch_array($jabatan)) {
                            ?>
                              <option <?php echo $rowjab['id_golongan'] == $row['id_golongan'] ? "selected" : ''  ?> value="<?php echo $rowjab['id_golongan']; ?>"><?php echo $rowjab['nama_golongan']; ?></option>
                            <?php
                            }
                            ?>
                          </select>
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="sisa_cuti" value="<?php echo $row['sisa_cuti']; ?>">
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form data-parsley-validate class="form-horizontal form-label-left" method="POST">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Sisa Cuti</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="number" class="form-control" name="sisa_cuti">
                    </div>
                  </div>
...
if (isset($_POST['submit'])) {
  ...
  $query = mysqli_query($koneksi, "INSERT INTO pegawai VALUES (null, '$namapegawai','$nippegawai', '$jabatanpegawai', '$golpegawai', 'KELURAHAN TELAGA ASIH', '$sisa_cuti')");
