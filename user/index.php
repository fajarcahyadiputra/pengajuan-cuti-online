...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="../build/images/logotelagaasih.png">
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php?page=dashboard" class="site_title"><i class="fa fa-university"></i><span>  TELAGA ASIH</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="../build/images/logotelagaasih.png" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Kelurahan</span>
                <span>Telaga Asih</span>
              </div>
            </div>
            <!-- /menu profile quick info -->
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                if ($jabatanpegawai == 'PANITERA' || $jabatanpegawai == 'SEKRETARIS' || $jabatanpegawai =='KETUA' || $jabatanpegawai =='PANMUD HUKUM' || $jabatanpegawai =='PANMUD HUKUM GUGATAN' || $jabatanpegawai =='PANMUD HUKUM PERMOHONAN' || $jabatanpegawai =='KASUBAG KEPEGAWAIAN DAN ORTALA' || $jabatanpegawai =='KASUBAG PERNCANAAN, IT DAN PELAPORAN' || $jabatanpegawai =='KASUBAG UMUM DAN KEUANGAN' || $jabatanpegawai =='Kasi Pemerintahan dan Pelayanan Masyarakat') {
                  ?>
                  ...
                  <li role="presentation" class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                      ...
                      if ($jabatanpegawai =='PANMUD HUKUM' || $jabatanpegawai =='PANMUD HUKUM GUGATAN' || $jabatanpegawai =='PANMUD HUKUM PERMOHONAN' || $jabatanpegawai =='KASUBAG KEPEGAWAIAN DAN ORTALA' || $jabatanpegawai =='KASUBAG PERNCANAAN, IT DAN PELAPORAN' || $jabatanpegawai =='KASUBAG UMUM DAN KEUANGAN'|| $jabatanpegawai =='Kasi Pemerintahan dan Pelayanan Masyarakat'|| $jabatanpegawai =='Kasi Kependudukan'|| $jabatanpegawai =='Kasi Ketentraman dan Ketertiban') {
        ...
        <footer>
          <div class="pull-right">
            KELURAHAN TELAGA ASIH - Copyright © 2022</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
