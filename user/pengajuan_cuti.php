          ...
          <div class="x_content">
            <form method="POST">
              ...
              <div class="form-group">
                ...
                <input id="dari" type="date" required class="form-control" name="dari_tanggal">
              </div>
              <div class="form-group">
                <label for="">Sampai dengan</label>
                <input id="sampai" type="date" required class="form-control" name="sampai_dengan">
              </div>
              <div class="form-group">
                <label for="">Lamanya cuti</label>
                <input id="lama_hari" type="text" required class="form-control" placeholder="Masukan berapa lama" name="lama_cuti">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="atasan">
                  ...
                  <?php
                  } elseif ($jabatan == 'PANITERA' || $jabatan == 'SEKRETARIS' || $jabatan == 'HAKIM UTAMA MUDA' || $jabatan == 'HAKIM MADYA UTAMA' || $jabatan == 'Kasi Pemerintahan dan Pelayanan Masyarakat' || $jabatan == 'Kasi Kependudukan' || $jabatan == 'Kasi Ketentraman dan Ketertiban' || $jabatan == 'WAKIL KETUA') {
                  ?>
...
<script>
  $(document).ready(function() {
    $(document).on("change", "#sampai", function() {
      let dari = $("#dari").val();
      let sampai = $(this).val();
      $("#lama_hari").val(date_diff_indays(dari, sampai))
    })
...
if (isset($_POST['submit'])) {
  ...
  if ($lama > $rowid['sisa_cuti']) {
    echo "
    <script>alert('Hak cuti tidak cukup'); 
    document.location='index.php?page=daftar_approval';</script>";
    die();
  }

  $sisaCuti = $rowid['sisa_cuti'] - $lama;
  mysqli_query($koneksi, "UPDATE pegawai SET sisa_cuti='$sisaCuti'  WHERE nip='$nip'");
